        ...
        pages: {
            menu: {
                ...
                buttons: {
                    ...
                    permissionName: '权限名称',
                    permissionNamePlaceholder: '输入权限名称搜索',
                    permissionValue: '权限值',
                    permissionValuePlaceholder: '输入权限标识',
                    requestMethod: '请求方式',
                    apiEndpoint: '接口地址',
                    batchGenerate: '批量生成',
                ...
                helpers: {
                    ...
                    manualInputDesc: '页面中按钮的名称或者自定义一个名称',
                    uniqueValueTitle: '唯一值',
                    uniqueValueDesc: '用于判断前端按钮权限或接口权限',
                    apiHelperTitle: '请正确填写，以免请求时被拦截。匹配单例使用正则,例如:/api/xx/.*?/',
                },
            },
        },
    },
