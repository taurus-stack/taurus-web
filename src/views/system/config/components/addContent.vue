...
let ruleOptions = ref([
	{
		...
		value: `{"required": true, "message": "${t('message.pages.config.validationRules.requiredMessage')}"}`,
	},
	{
		label: t('message.pages.config.validationRules.email'),
		value: `{ "type": "email", "message": "${t('message.pages.config.validationRules.emailMessage')}"}`,
	},
	{
		label: t('message.pages.config.validationRules.url'),
		value: `{ "type": "url", "message": "${t('message.pages.config.validationRules.urlMessage')}"}`,
	},
]);
const getParent = () => {
	api
