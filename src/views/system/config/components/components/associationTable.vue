<template>
	<div>
		<el-form :model="formObj" ref="associationRef">
			<el-form-item :label="t('message.pages.config.associationTable.tableLabel')" prop="table" :rules="[{ required: true, message: t('message.pages.config.validationRules.required'), trigger: 'blur' }]">
			...
			<el-form-item :label="t('message.pages.config.associationTable.displayField')" prop="field" :rules="[{ required: true, message: t('message.pages.config.validationRules.required'), trigger: 'blur' }]">
			...
			<el-form-item :label="t('message.pages.config.associationTable.storageField')" prop="primarykey" :rules="[{ required: true, message: t('message.pages.config.validationRules.required'), trigger: 'blur' }]">
			...
			<el-form-item :label="t('message.pages.config.associationTable.filterCondition')" prop="oldSearchField" :rules="[{ required: true, message: t('message.pages.config.validationRules.required'), trigger: 'blur' }]">
