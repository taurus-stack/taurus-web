		...
		<el-row class="columns-el-row" :gutter="10">
			<el-col :span="6">
				<div class="columns-box columns-left">
					<ItemCom :title="t('message.importExcel.role')" type="role" showPagination @fetchData="fetchRoleData" @itemClick="handleClick" />
				</div>
			</el-col>
<!--      <el-col :span="4">-->
<!--        <div class="columns-box columns-left">-->
...
<!--      </el-col>-->
			<el-col :span="8">
				<div class="columns-box columns-center">
					<ItemCom :title="t('message.importExcel.modelTable')" type="model" label="showText" value="key" @fetchData="fetchModelData" @itemClick="handleClick" />
				</div>
			</el-col>
			<el-col :span="10">
