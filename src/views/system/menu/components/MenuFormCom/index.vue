<template>
	<div class="menu-form-com">
		<div class="menu-form-alert">
			{{ t('message.pages.menu.form.alertLine1') }}<br />
			{{ t('message.pages.menu.form.alertLine2') }}<br />
			{{ t('message.pages.menu.form.alertLine3') }}
		</div>
		<el-form ref="formRef" :rules="rules" :model="menuFormData" label-width="130px" label-position="right">
			<el-form-item :label="t('message.pages.menu.form.menuName')" prop="name">
				<el-input v-model="menuFormData.name" :placeholder="t('message.pages.menu.form.menuNamePlaceholder')" />
			</el-form-item>
			<el-form-item :label="t('message.pages.menu.form.parentMenu')" prop="parent">
				<el-tree-select
					...
					clearable
					:load="handleTreeLoad"
					:placeholder="t('message.pages.menu.form.parentMenuPlaceholder')"
					style="width: 100%"
				/>
			</el-form-item>
			...
			<el-row>
				<el-col :span="12">
					<el-form-item required :label="t('message.pages.menu.form.status')">
						<el-switch v-model="menuFormData.status" width="60" inline-prompt :active-text="t('message.pages.menu.form.enabled')" :inactive-text="t('message.pages.menu.form.disabled')" />
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item v-if="menuFormData.status" required :label="t('message.pages.menu.form.visible')">
						<el-switch v-model="menuFormData.visible" width="60" inline-prompt :active-text="t('message.pages.menu.form.show')" :inactive-text="t('message.pages.menu.form.hide')" />
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row>
				<el-col :span="12">
					<el-form-item required :label="t('message.pages.menu.form.isCatalog')">
						<el-switch v-model="menuFormData.is_catalog" width="60" inline-prompt :active-text="t('message.pages.menu.form.yes')" :inactive-text="t('message.pages.menu.form.no')" />
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item v-if="!menuFormData.is_catalog" required :label="t('message.pages.menu.form.isLink')">
						<el-switch v-model="menuFormData.is_link" width="60" inline-prompt :active-text="t('message.pages.menu.form.yes')" :inactive-text="t('message.pages.menu.form.no')" />
					</el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item required v-if="!menuFormData.is_catalog" :label="t('message.pages.menu.form.isAffix')">
            <el-switch v-model="menuFormData.is_affix" width="60" inline-prompt :active-text="t('message.pages.menu.form.yes')" :inactive-text="t('message.pages.menu.form.no')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="!menuFormData.is_catalog && menuFormData.is_link" required :label="t('message.pages.menu.form.isIframe')">
            <el-switch v-model="menuFormData.is_iframe" width="60" inline-prompt :active-text="t('message.pages.menu.form.yes')" :inactive-text="t('message.pages.menu.form.no')" />
          </el-form-item>
        </el-col>
			</el-row>

			<el-form-item :label="t('message.pages.menu.form.remark')">
				<el-input v-model="menuFormData.description" maxlength="200" show-word-limit type="textarea" :placeholder="t('message.pages.menu.form.remarkPlaceholder')" />
			</el-form-item>
			...
			<div style="min-height: 184px">
				<el-form-item v-if="!menuFormData.is_catalog && !menuFormData.is_link" :label="t('message.pages.menu.form.component')" prop="component">
					<el-autocomplete
						...
						clearable
						:debounce="100"
						:placeholder="t('message.pages.menu.form.componentPlaceholder')"
					/>
				</el-form-item>

				<el-form-item v-if="!menuFormData.is_catalog && !menuFormData.is_link" :label="t('message.pages.menu.form.componentName')" prop="component_name">
				...
				<el-form-item v-if="!menuFormData.is_catalog" :label="t('message.pages.menu.form.cache')">
					<el-switch v-model="menuFormData.cache" width="60" inline-prompt :active-text="t('message.pages.menu.form.enabled')" :inactive-text="t('message.pages.menu.form.disabled')" />
				</el-form-item>
			</div>
...
const rules = reactive<FormRules>({
	...
	name: [{ required: true, message: t('message.pages.menu.validation.menuNameRequired'), trigger: 'blur' }],
