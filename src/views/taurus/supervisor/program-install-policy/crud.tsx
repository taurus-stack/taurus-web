import * as api from '/@/api/taurus/supervisor/program-install-policy';
import { UserPageQuery, AddReq, DelReq, EditReq, CreateCrudOptionsProps, CreateCrudOptionsRet } from '@fast-crud/fast-crud';
import { getProgramInstallPolicyConfig } from './table';

export const createCrudOptions = function ({ crudExpose }: CreateCrudOptionsProps): CreateCrudOptionsRet {
	const tableConfig = getProgramInstallPolicyConfig();
