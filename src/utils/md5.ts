// Inline MD5 implementation, used only for password hashing. Replaces ts-md5 to avoid
// Vite dev server MIME type parsing issues.
// Based on Paul Johnston's public domain implementation.
